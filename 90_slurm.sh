...
#SBATCH --job-name=monocomf    # some descriptive job name of your choice
...
#SBATCH --mem=100G                # memory required per node, in the form of [num][M|G|T]
...
Rscript run_nma_mars.R mono common fixed