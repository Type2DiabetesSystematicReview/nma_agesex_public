...
mace <- c("NCT00790205", "NCT00968708", "NCT01032629", "NCT01107886", 
          "NCT01131676", 
          "NCT01144338", "NCT01147250", "NCT01179048", "NCT01243424", 
          "NCT01394952", "NCT01455896", "NCT01703208", "NCT01720446", "NCT01730534", 
          "NCT01897532", "NCT01986881", "NCT01989754", "NCT02065791", "NCT02465515", 
          "NCT02692716", "NCT03315143", "NCT03496298", "NCT03521934")
tot[,-1] <- map(tot[,-1], ~ map(.x, ~ .x  %>% filter(nct_id %in% mace)))
...
saveRDS(mdl, "FromVM/hba1c_in_mace_trials.Rds")
rm(mdl)
gc()
