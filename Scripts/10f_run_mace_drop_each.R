...
if(length(args) == 0) stop("Need to pass arguments (eg in terminal via Rscript Scripts/10f_run_mace_drop_each.R ARGS HERE) to indicate which model wish to run")
