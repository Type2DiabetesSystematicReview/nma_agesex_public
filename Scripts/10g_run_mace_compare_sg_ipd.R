...
if(length(args) == 0) stop("Need to pass arguments (eg in terminal via Rscript Scripts/10g_run_mace_compare_sg_ipd.R ARGS HERE) to indicate which model wish to run")
